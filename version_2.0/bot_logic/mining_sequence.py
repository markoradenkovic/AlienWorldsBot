...
def locate_and_press_mine_button(bot):
    ...
    while mine_button_delay_counter < 10:
        time.sleep(1)
...
def locate_and_press_claim_button(bot):
    ...
    while claim_mine_button_delay_counter < 10:
        time.sleep(1)
...
def retrieve_approve_transaction_window_and_approve(bot):
    ...
    window_found = False
    while approve_window_delay_counter < 10:
    ...
    if window_found:
        ...
        time.sleep(1)
        web_element = weh.retrieve_element_by_xpath(bot.driver, '/html/body/div/div/section/div[2]/div/div[5]/button')
